import{t as e}from"./model-CRfxCuC8-habitat-ai.js";import{t}from"./sources-C57U0P-9-habitat-ai.js";var n=[e(`stellar-physics`,`Una estrella se sostiene desde dentro`,`Antes de imaginar máquinas alrededor de un sol, conviene ver el equilibrio que mantiene encendida a la propia estrella.`,[t.sun,t.stars],`
...
`),e(`stellar-engines`,`La estrella también puede ser el vehículo`,`Un motor estelar intentaría modificar el movimiento de una estrella, y con él el futuro recorrido de los cuerpos que permanecen ligados a ella.`,[t.caplan,t.sun],`
...
`),e(`shkadov`,`Un espejo para desequilibrar la luz`,`El propulsor de Shkadov usa una idea sencilla a una escala desmesurada: si la radiación sale de forma asimétrica, el conjunto puede recibir un empuje neto.`,[t.caplan,t.sails,t.thermal],`
...
`),e(`caplan`,`Remolcar un sol con su propia materia`,`El motor propuesto por Caplan incorpora flujos materiales para aspirar a aceleraciones mayores que las de un reflector pasivo.`,[t.caplan,t.fusion,t.thermal],`
...
`),e(`star-lifting`,`Extraer materia de una estrella`,`El star lifting imagina convertir parte del material estelar en un recurso. Antes de almacenarlo, habría que sacarlo de un pozo gravitatorio enorme.`,[t.sun,t.lifting,t.caplan],`
...
`),e(`stellar-husbandry`,`Cuidar el ritmo de una estrella`,`Algunos modelos preguntan si una civilización podría prolongar condiciones estelares favorables. El objetivo sería ganar tiempo, no encender una fuente eterna.`,[t.lifting,t.stars,t.habitable],`
...
`),e(`stellar-navigation`,`Elegir por dónde pasará un sistema solar`,`Navegar con una estrella significa planificar dentro de una galaxia que también se mueve. Los destinos no esperan quietos en un mapa.`,[t.caplan,t.stars],`
...
`),e(`plasma-processing`,`La materia llega cargada y ardiendo`,`Una industria estelar necesitaría convertir flujos de plasma en materiales manejables. Recoger energía y fabricar un producto son trabajos distintos.`,[t.sun,t.ion,t.thermal],`
...
`),e(`black-hole-engineering`,`Trabajar alrededor del lugar del que nada regresa`,`Un agujero negro puede tener un entorno extraordinariamente energético. Aprovecharlo exigiría permanecer fuera del horizonte y distinguir procesos físicos muy diferentes.`,[t.bhAnatomy,t.blackholes,t.thermal],`
...
`),e(`stellar-technosignatures`,`Reconocer una intervención en la luz de una estrella`,`Si alguien construyera a escala estelar, quizá veríamos su efecto antes de distinguir una sola pieza.`,[t.dyson,t.lifting,t.seti],`
