import{t as e}from"./model-Bz0plcWQ-habitat-ai.js";import{t}from"./sources-BQH6_LhH-habitat-ai.js";var n=[e(`space-based-solar`,`Recoger el día por encima de las nubes`,`La energía solar espacial propone captar luz en órbita y entregar electricidad donde se necesita. Entre ambos extremos hay varias conversiones y una infraestructura que debe justificar su tamaño.`,[t.solarPower,t.thermal],`
Sobre la atmósfera, una superficie solar no tiene nubes pasando delante de ella. Puede orientarse hacia el Sol y recibir una iluminación cuyo ritmo depende de la órbita y de los eclipses. La idea de una central solar espacial empieza en esa diferencia respecto a un panel instalado sobre el terreno.

Imagina una estructura desplegada con grandes superficies de captación y un sistema de transmisión apuntando hacia un receptor. Desde la Tierra, ese receptor podría ocupar una extensión considerable. La central no sería únicamente el satélite brillante: incluiría conversión, control, estaciones receptoras y conexión con una red eléctrica.

NASA publicó en 2024 una evaluación de energía solar espacial que examina beneficios, dificultades y opciones de desarrollo. Un estudio de esa clase compara arquitecturas y supuestos; no demuestra que exista una central competitiva lista para sustituir generación terrestre. [1]

## La electricidad tiene que hacer un viaje
...
Si tres etapas hipotéticas tuvieran rendimientos de 40 %, 70 % y 80 %, el rendimiento combinado sería 0,40 × 0,70 × 0,80 = 22,4 %. Son cifras ilustrativas, no prestaciones atribuidas a un proyecto. Muestran por qué mejoras en cada etapa y pérdidas fuera del haz importan tanto.

:::

Lanzamiento, ensamblaje, reposición de componentes y receptor terrestre forman parte del coste. El recurso solar puede ser abundante y aun así resultar caro convertirlo en electricidad entregada. Las comparaciones deben incluir alternativas terrestres y el servicio concreto que se pretende ofrecer. [1]

La imagen final une dos lugares: una superficie iluminada lejos de las nubes y una instalación que recoge energía bajo el cielo terrestre. Entre ellas existe una cadena invisible. Comprenderla permite apreciar el concepto por lo que realmente propone: trasladar parte de la generación a otro entorno y resolver después cómo conectar ese entorno con nuestra vida cotidiana.
`),e(`microwave-power`,`Un cable hecho de radiación`,`Enviar energía mediante un haz exige controlar su extensión, su trayectoria y su conversión. La distancia separa emisor y receptor, pero sigue uniéndolos mediante un balance preciso.`,[t.solarPower,t.starshot],`
Una antena transmite hacia otra instalación situada muy lejos. A simple vista quizá no ocurre nada. No hace falta que el haz dibuje una línea luminosa en el vacío para que transporte energía. Las microondas y la luz láser pertenecen al espectro electromagnético; su utilidad depende de cómo se generan, propagan y reciben.

En una red espacial hipotética, un vehículo podría obtener potencia desde una estación y reducir parte de sus equipos de generación. El receptor tendría que permanecer dentro de una región iluminada y convertir la radiación en la forma energética adecuada. La dependencia se traslada al enlace y a la infraestructura emisora.

## La puntería no derrota a la difracción
...
Para una apertura circular ideal, el ángulo característico de difracción escala como θ ≈ 1,22 λ/D. A distancia R, una escala transversal del haz es Rθ. Es una aproximación óptica; un sistema real incorpora perfiles, turbulencia, errores de fase y otras pérdidas.

:::

## La energía puede convertirse o empujar
...
`),e(`radiators`,`Las alas que no recogen luz`,`Una nave puede tener superficies enormes dedicadas a deshacerse de energía. El calor residual convierte el espacio vacío en un problema de área, temperatura y orientación.`,[t.thermal],`
En la ilustración de una nave, dos paneles oscuros se extienden desde el cuerpo central. Es tentador llamarlos alas o placas solares. Pero quizá su función sea opuesta a la de un colector: enviar energía hacia fuera. Son radiadores, superficies diseñadas para emitir calor como radiación electromagnética.
...
Para una superficie idealizada que radia hacia un entorno mucho más frío, P ≈ εσAT⁴. ε es la emisividad, σ la constante de Stefan–Boltzmann, A el área emisora y T la temperatura absoluta en kelvin. Un entorno que también radia requiere incluir la energía recibida.

Si la temperatura emisora se duplica, la potencia por unidad de área aumenta por un factor de dieciséis en esa aproximación. Pero no podemos subirla sin límite: materiales, fluidos y equipos tienen temperaturas admisibles. Diseñar una máquina más caliente modifica todo el sistema. [1]

:::

## El tamaño revela una decisión interior
...
La próxima vez que una imagen muestre una nave poderosa, busca por dónde sale su calor. Esa pregunta permite reconstruir una parte invisible de su funcionamiento. A menudo, las superficies menos vistosas cuentan mejor que la llama del motor cuánta energía está circulando realmente por ella.
`),e(`dyson-swarm`,`Una estrella vista a través de una civilización`,`Un enjambre Dyson imagina una infraestructura distribuida que intercepta parte de la luz estelar. Su escala se entiende mejor siguiendo a uno de sus colectores que dibujando una esfera cerrada.`,[t.dyson,t.solarPower,t.thermal,t.kardashev],`
Una estrella llena el campo de visión de una nave protegida. Delante de ella cruza una superficie artificial y desaparece lentamente hacia un lado. Otra está tan lejos que parece un punto. Entre ambas no hay una pared: hay espacio, trayectorias y distancias que podrían ser comparables a las que separan mundos.

Así puede empezar a imaginarse un enjambre Dyson. Es una familia de propuestas en la que numerosas unidades interceptarían luz de una estrella. Cada unidad podría cumplir funciones de captación, uso de energía, fabricación o habitación. El conjunto no necesita ser una cáscara rígida ni tener una frontera visual continua. [1]

La palabra «enjambre» puede sugerir objetos muy juntos, pero la escala astronómica cambia esa intuición. Una distribución que captura una fracción importante de la radiación podría seguir conteniendo regiones enormes de vacío. La apariencia depende de cuánto material exista, de sus órbitas y de cómo se orienten sus superficies.

## Seguir un colector

Imagina acercarte a una de las unidades. En el lado orientado hacia la estrella habría superficies que reciben radiación. En otras direcciones aparecerían equipos y áreas destinadas a expulsar calor. La unidad tendría que conocer su orientación, corregir perturbaciones y mantener sus funciones pese a radiación, impactos y degradación.

Captar energía no significa necesariamente enviarla toda a un planeta. Usarla cerca de donde se obtiene podría evitar parte del transporte, aunque exigiría situar también allí las actividades consumidoras. Transmitirla a distancia introduce emisores, receptores, pérdidas y control del haz. Las cadenas de conversión estudiadas para energía solar espacial ofrecen una referencia cercana de esos problemas, aunque un enjambre estelar está muchísimo más allá de esa escala. [2]

Una unidad tampoco puede ignorar a las demás. Sombras, cruces de órbitas y emisiones afectan el diseño. Al crecer la población de objetos, resulta necesario separar trayectorias y planificar el tráfico. «Están en órbita» no significa que puedan colocarse de cualquier manera sin riesgo de encuentro.

## La estrella emite en todas direcciones

Un planeta intercepta una parte pequeña de la luz estelar porque su sección es diminuta frente a la esfera imaginaria sobre la que se reparte esa luz. Colocar captadores en más lugares permitiría, en principio, interceptar una fracción mayor. Esa es la intuición energética del enjambre.

La fracción captada importa más que una afirmación vaga de «rodear» la estrella. Un conjunto parcial puede ser enorme desde nuestra perspectiva y seguir aprovechando una parte reducida de la luminosidad total. No hay un instante único en que una colección de satélites se convierta físicamente en un enjambre completo.

La escala de Kardashev suele asociar el Tipo II con recursos de orden estelar. Es una referencia de potencia, no una especificación de cuántos colectores necesita una sociedad ni una predicción de que deseará construirlos. Una civilización podría tener otras prioridades o detener el crecimiento mucho antes. [4]

::: Potencia interceptada y potencia útil

Si la estrella tiene luminosidad L y el sistema intercepta una fracción f, la potencia recibida es fL. La potencia disponible para una función concreta depende después de conversiones, geometría y pérdidas. No debe confundirse potencia interceptada con electricidad entregada ni con trabajo útil.

También hay que distinguir masa de colectores y masa de toda la infraestructura. Aumentar la superficie captadora puede requerir soportes, comunicaciones, control, mantenimiento y sistemas térmicos que no aparecen en una estimación basada únicamente en una lámina ideal.

:::

## Crecer cambia el problema

Una primera instalación podría construirse mediante recursos transportados desde otros lugares. A medida que crece la actividad, aparecen preguntas sobre extracción de materiales, fabricación y reparación. La expansión no está garantizada por la abundancia de luz: necesita cadenas industriales que conviertan esa energía en objetos fiables.

La automatización puede reducir ciertas necesidades humanas, pero no elimina inspección, fallos o aprovisionamiento. Una fábrica autónoma necesita materiales adecuados y equipos que sigan funcionando. Reproducir instalaciones implica reproducir capacidades, no únicamente copiar una forma exterior.

La secuencia de crecimiento también puede introducir compromisos. Los primeros colectores ocupan órbitas y establecen interfaces. Una expansión posterior tendría que convivir con esas decisiones o pagar por cambiarlas. Una red desarrollada durante siglos conservaría una historia técnica en su distribución.

## La luz que reaparece como calor

Después de ser absorbida y utilizada, una parte importante de la energía debe abandonar el sistema como radiación térmica. Las temperaturas y las superficies emisoras determinan cómo ocurre. El calor no es un detalle añadido al final: condiciona distancias a la estrella, materiales y dimensiones. [3]

Un observador lejano podría buscar distribuciones de radiación inusuales, por ejemplo una combinación de luz estelar y emisión infrarroja. Pero el polvo y otros fenómenos naturales también modifican espectros. La interpretación tecnológica requeriría evidencia adicional y modelos que expliquen por qué las alternativas resultan insuficientes. [1]

La ausencia de una firma concreta tampoco descartaría toda ingeniería imaginable. Las búsquedas dependen de supuestos sobre cobertura, temperatura, geometría y sensibilidad. Una observación puede poner límites a ciertas configuraciones sin resolver todas las posibilidades.

## Una red de lugares, no una sola sala de máquinas

Desde dentro de esa civilización hipotética, el enjambre podría experimentarse como un conjunto de regiones. Viajar entre instalaciones exigiría tiempo. Las comunicaciones tendrían retrasos. Algunas comunidades podrían vivir en hábitats; otras operaciones podrían estar totalmente automatizadas.

La abundancia energética no determina cómo se distribuyen recursos o decisiones. Una instalación esencial puede introducir dependencia, y una red muy extensa necesita mecanismos de coordinación. La organización social no viene incluida en la ecuación de luminosidad.

La escena del colector que cruza frente a la estrella permite mantener la escala humana sin empequeñecer la idea. Esa superficie sería un lugar concreto, con piezas y tareas. Su importancia cósmica aparecería al repetir la posibilidad en muchas trayectorias distintas. La estrella seguiría brillando; parte de su luz empezaría a contar una historia sobre lo que alguien decidió construir a su alrededor.
`),e(`dyson-shell`,`La esfera perfecta que la física empieza a desmontar`,`Una cáscara rígida alrededor de una estrella es una imagen inmediata. Examinarla revela por qué las variantes distribuidas suelen resultar más razonables como punto de partida.`,[t.dyson,t.gravity],`
Una superficie continua envuelve una estrella. Desde fuera parece una esfera oscura; desde dentro, la imaginación dibuja un territorio extendido alrededor de un sol central. La imagen es tan clara que puede hacernos olvidar que una estructura no se sostiene por ser simétrica en un dibujo.
...
`),e(`dyson-bubble`,`Superficies que intentarían quedarse suspendidas en la luz`,`Los statites exploran el equilibrio entre gravedad y presión de radiación. Una burbuja de estas unidades tendría una dinámica distinta de un enjambre de satélites convencionales.`,[t.sails,t.dyson],`
Una lámina reflectante permanece, en una escena hipotética, sobre una región de una estrella sin seguir la órbita circular que esperaríamos. La luz que recibe transporta momento. Al reflejarse, ejerce una fuerza que puede oponerse parcialmente a la gravedad. La posibilidad depende de que la superficie sea extraordinariamente ligera respecto a su área.

Un statite es una propuesta de sustentación mediante presión de radiación, relacionada con la física de las velas solares. Una Dyson Bubble imagina una gran colección de unidades de ese tipo. No describe una membrana inflada ni una estructura que flota porque la luz anule universalmente la gravedad. [1]

## Dos efectos que disminuyen con la distancia
...
Para un haz de potencia P absorbido perpendicularmente, la fuerza ideal es P/c. Con reflexión perfecta y retorno en sentido opuesto, es 2P/c. La velocidad de la luz c hace que incluso potencias grandes produzcan fuerzas modestas. Una vela aprovecha esas fuerzas mediante una masa pequeña y actuación prolongada. [1]

:::

## Un equilibrio que necesita vigilancia
...
La escena no sería inmóvil en un sentido profundo. Cada superficie estaría negociando continuamente con un flujo de fotones. Permanecer en un lugar podría exigir tanta actividad de control como desplazarse hacia otro.
`),e(`dyson-ring`,`Empezar por una banda de luz interceptada`,`Un anillo o una red parcial de colectores permite pensar el crecimiento de una infraestructura estelar sin suponer que toda la estrella debe quedar cubierta.`,[t.dyson,t.thermal],`
Una vista lejana muestra puntos artificiales concentrados aproximadamente en una banda alrededor de una estrella. La palabra «anillo» invita a unirlos con una línea, pero una configuración distribuida puede estar formada por unidades separadas. Cada una conserva una trayectoria y una orientación que deben ser compatibles con las demás.

Dyson Ring y Dyson Net son nombres usados para variantes o disposiciones parciales de captación estelar. No designan una única arquitectura normalizada. Para evaluar una propuesta hay que precisar si el material está conectado, cómo se mueve y qué fracción de la radiación intercepta. [1]

## Una primera instalación ya impone decisiones
...
Duplicar área captadora no implica duplicar capacidad útil si transmisión, almacenamiento o radiadores se convierten en cuellos de botella. El sistema crece al coordinar capacidades complementarias, no al repetir indefinidamente una sola pieza.
...
`),e(`matrioshka-brain`,`Pensar entre una estrella caliente y un universo frío`,`Un cerebro Matrioshka imagina capas de procesamiento a diferentes temperaturas. La clave no es reutilizar energía indefinidamente, sino aprovechar diferencias térmicas antes de que la energía se disperse.`,[t.dysonThermal,t.computation,t.thermal],`
Imagina alejarte de una estrella atravesando regiones de infraestructura hipotética. Las primeras reciben radiación intensa. Más afuera, otras trabajan con radiación procedente de zonas interiores. Cada región opera bajo condiciones térmicas distintas. El conjunto evoca muñecas encajadas, aunque no necesita estar formado por cáscaras rígidas continuas.
...
El límite de Landauer relaciona el borrado lógicamente irreversible de un bit con una disipación mínima kBT ln 2 bajo sus supuestos. kB es la constante de Boltzmann y T la temperatura del entorno relevante. No es el consumo real garantizado de toda operación informática, ni elimina pérdidas de memoria, comunicación y control.
...
Una infraestructura de computación enorme no demuestra que contenga una mente, ni que una mente hipotética desee vivir en ella. Podría usarse para simulación, investigación u otras actividades. Las interpretaciones sobre conciencia digital requieren argumentos adicionales, independientes del balance energético.

Desde fuera, el sistema podría aparecer como radiación reorganizada en diferentes temperaturas. Desde dentro de una de sus instalaciones, quizá solo se percibiría una red de equipos con un trabajo local. El contraste entre ambas vistas es la fuerza de la idea: una estrella convertida en contexto físico para procesar información, sin que la magnitud de la máquina nos diga por sí sola qué estaría pensando.
`),e(`jupiter-brain`,`Una máquina tan grande que sus partes tendrían que esperar`,`Un computador de escala planetaria promete capacidad enorme, pero su tamaño introduce retrasos, calor y coordinación. La geometría influye en qué clase de problemas podría resolver.`,[t.computation,t.thermal],`
Desde una nave lejana, un computador de escala planetaria podría parecer un mundo: una superficie extensa, emisión térmica y regiones con funciones diferentes. Al acercarse, la organización artificial sería más importante que la forma redonda. El nombre Jupiter Brain representa una idea especulativa de procesamiento masivo, no la conversión demostrada de un planeta en ordenador.
...
En una estructura hipotética de 100.000 km de diámetro, la luz tarda aproximadamente un tercio de segundo en cruzar de un lado al otro en vacío. Un viaje de ida y vuelta requiere el doble. Son límites geométricos ideales; dispositivos y materiales introducen demoras adicionales.

:::

## La superficie tiene que liberar lo que ocurre dentro

Concentrar procesamiento y fuentes de potencia produce un problema térmico. El calor debe viajar hacia lugares desde los que pueda emitirse. Aumentar volumen no aumenta superficie exterior en la misma proporción, de modo que una forma compacta puede complicar la evacuación térmica.
...
`),e(`computronium`,`Materia organizada para responder preguntas`,`Computronium es un nombre para un ideal de materia dedicada al procesamiento de información. No identifica una sustancia descubierta ni una tecnología única.`,[t.computation],`
Sobre una mesa, dos objetos pueden contener los mismos elementos químicos y hacer cosas completamente distintas. En uno, la materia forma una carcasa; en otro, una organización precisa de estados permite guardar y transformar información. La computación depende de la disposición física y de los procesos que esa disposición admite.
...
El límite kBT ln 2 se asocia al borrado irreversible de un bit bajo determinados supuestos termodinámicos. La computación reversible estudia cómo evitar ciertas pérdidas lógicas, pero una máquina real sigue necesitando controlar errores, intercambios y tiempos. La palabra «reversible» no promete consumo nulo a velocidad arbitraria.
