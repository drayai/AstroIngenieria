import{t as e}from"./model-CRfxCuC8-habitat-ai.js";import{t}from"./sources-C57U0P-9-habitat-ai.js";var n=[e(`chemical-rockets`,`Llevar contigo la forma de empujar`,`Un cohete funciona en el vacío porque expulsa masa. La llama es la parte visible de un intercambio de momento que comienza en los depósitos.`,[t.rocket,t.propulsion],`
...
`),e(`ion-engines`,`Una fuerza pequeña que tiene tiempo`,`Los motores iónicos pueden cambiar mucho una trayectoria sin un gran impulso visible. Su ventaja aparece cuando una misión puede mantener el empuje durante periodos prolongados.`,[t.ion,t.propulsion],`
...
`),e(`hall-thruster`,`El anillo donde los electrones toman otro camino`,`Un propulsor Hall utiliza campos eléctricos y magnéticos con funciones diferentes. Comprender esa separación permite ver qué ocurre detrás del resplandor del plasma.`,[t.sep,t.propulsion],`
...
`),e(`solar-electric`,`Viajar con la potencia que llega del Sol`,`La propulsión solar eléctrica conecta paneles, electrónica y motores de plasma. La distancia a la estrella cambia cuánto puede hacer la nave en cada etapa.`,[t.sep,t.ion],`
...
`),e(`nuclear-thermal`,`Un reactor en lugar de una combustión`,`La propulsión nuclear térmica utiliza un reactor para calentar una masa que luego sale por una tobera. Energía nuclear y propelente cumplen papeles diferentes.`,[t.nuclear,t.rocket],`
...
`),e(`nuclear-electric`,`Una central que viaja con sus motores`,`Separar reactor y propulsores permite generar electricidad lejos del Sol. La autonomía energética viene acompañada por conversión, radiadores y una masa que también hay que acelerar.`,[t.nuclear,t.thermal,t.propulsion],`
...
`),e(`solar-sail`,`Un barco donde sopla la luz`,`Una membrana desplegada en el vacío puede cambiar de órbita sin encender un motor. Su viento es la propia luz.`,[t.sails,t.propulsion],`
...
`),e(`laser-sail`,`La nave se lleva la vela; el motor se queda en casa`,`Un haz dirigido podría impulsar una sonda muy ligera hacia otra estrella. La parte gigantesca del vehículo estaría lejos de ella.`,[t.starshot,t.braking],`
...
`),e(`beamed-propulsion`,`Una carretera hecha de energía`,`Si la potencia llega desde fuera, la nave puede ahorrar parte de su central. A cambio, el viaje depende de una infraestructura que siga alcanzándola.`,[t.starshot,t.propulsion],`
...
`),e(`magnetic-sail`,`Desplegar un campo en vez de una tela`,`Una vela magnética intentaría empujar contra las partículas cargadas que atraviesan el espacio.`,[t.magsail],`
...
`),e(`electric-sail`,`Hilos cargados para recoger el viento solar`,`Una estrella no solo emite luz. También lanza partículas, y una vela eléctrica propone aprovechar ese segundo viento.`,[t.esail,t.sails],`
...
`),e(`project-orion`,`Una nave que avanzaría a golpes`,`Orion imaginó un vehículo enorme impulsado por pulsos nucleares externos. Su desafío central era convertir golpes violentos en una aceleración soportable.`,[t.orion],`
...
`),e(`fusion-propulsion`,`Llevar una reacción estelar sin llevar una estrella`,`La fusión promete un escape muy energético. Convertir esa promesa en un motor exige controlar la reacción, el calor y la masa de toda la instalación.`,[t.fusion,t.thermal],`
...
`),e(`antimatter`,`La energía más concentrada y el depósito más difícil`,`Materia y antimateria pueden transformar su masa en otras partículas. Guardar, producir y aprovechar ese encuentro resulta mucho menos sencillo que escribir E = mc².`,[t.antimatter,t.rocket],`
...
`),e(`bussard-ramjet`,`Recoger el combustible durante el viaje`,`El ramjet de Bussard imagina una nave que se alimenta del gas interestelar. El problema es que capturarlo también puede frenarla.`,[t.ramjet,t.fusion],`
...
`),e(`relativistic-propulsion`,`Viajar tan rápido que los relojes se separan`,`Acercarse a la velocidad de la luz transforma la energía necesaria, el entorno de la nave y la relación entre quienes parten y quienes se quedan.`,[t.starshot,t.ramjet,t.thermal],`
...
`),e(`interstellar-braking`,`La otra mitad del viaje`,`Una estrella puede pasar por la ventanilla sin convertirse nunca en un destino. Para quedarse, hay que llegar con la velocidad adecuada.`,[t.braking,t.magsail,t.rocket],`
...
`),e(`alcubierre`,`Dibujar un viaje en la geometría`,`La métrica de Alcubierre pregunta qué forma tendría el espacio-tiempo de una burbuja viajera. No proporciona una máquina capaz de crearla.`,[t.warp,t.warpReview],`
...
`),e(`wormholes`,`Dos lugares unidos por una garganta`,`Un agujero de gusano atravesable sería una conexión entre regiones del espacio-tiempo. La palabra clave es atravesable: muchas geometrías no permiten un viaje de ida y vuelta.`,[t.wormholes,t.warpReview],`
...
`),e(`reactionless`,`El motor que obliga a mirar la balanza`,`Un dispositivo que promete empuje sin intercambiar movimiento con nada exige una prueba extraordinariamente cuidadosa.`,[t.emdrive,t.sails],`
